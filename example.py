...
#input_files = ['rootpy_trackbuilding3.py', 'histos_tb.10.npz', 'chsq.10.npz', 'model.10.h5', 'model_weights.10.h5', 'model.10.json']
input_files = ['rootpy_trackbuilding3_2GeV.py', 'histos_tb.10.npz', 'chsq_2GeV.10.npz', 'model_2GeV.10.h5', 'model_weights_2GeV.10.h5', 'model_2GeV.10.json']
